...
save_path = 'C:/Users/andre/Documents/exploor'
'''
    Initialize PyMongo
'''
...
user_info.ensure_index('id')
event_info.ensure_index('id')
attendance.ensure_index('uid')
attendance.ensure_index('eid')
attendance.ensure_index('uid'+ 'eid')
...
def process_events(uid, e_dict):
    ...
    for e in e_list:
        ...
        # see if event creator is a friend - may cause on average 0.2% lower values
...
def run_full():
    ...
    if not final:
        final_results = print(evaluate_test_results(results))
    #write_submission('C:/Users/andre/Documents/exploor/output.csv', final_results)
